...
if model_option == "SIR Model":
    ...
    # Plotting
    st.line_chart({"Susceptible": susceptible, "Infected": infected, "Recovered": recovered})
    ...
    # Plotting
    st.line_chart({"Susceptible": susceptible, "Infected": infected, "Recovered": recovered, "Deceased": deceased})
    ...
    # Plotting
    st.line_chart({"Susceptible": susceptible, "Infected": infected})
    ...
    # Plotting
    st.line_chart({"Susceptible": susceptible, "Exposed": exposed, "Infected": infected, "Recovered": recovered})